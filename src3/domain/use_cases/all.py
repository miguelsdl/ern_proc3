# src3/main/python/com/tuempresa/ddex/domain/use_cases/album_use_case.py
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/artist_use_case.py
@dataclass
class ArtistUseCase:
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/track_use_case.py
@dataclass
class TrackUseCase:
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/album_artist_use_case.py
@dataclass
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/album_genre_use_case.py
@dataclass
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/album_rights_use_case.py
@dataclass
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/album_track_use_case.py
@dataclass
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/genre_use_case.py
@dataclass
class GenreUseCase:
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/label_use_case.py
@dataclass
class LabelUseCase:
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/contributor_use_case.py
@dataclass
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/track_contributor_use_case.py
@dataclass
...
# src3/main/python/com/tuempresa/ddex/domain/use_cases/use_type_use_case.py
@dataclass
