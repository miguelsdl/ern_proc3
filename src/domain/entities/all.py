# src/main/python/com/tuempresa/ddex/domain/entities/albums/Album.py
...
# src/main/python/com/tuempresa/ddex/domain/entities/albums/AlbumArtist.py
@dataclass
class AlbumArtist:
...
# src/main/python/com/tuempresa/ddex/domain/entities/artists/Artist.py
@dataclass
class Artist:
...
# src/main/python/com/tuempresa/ddex/domain/entities/tracks/Track.py
@dataclass
class Track:
...
# src/main/python/com/tuempresa/ddex/domain/entities/albums/AlbumGenre.py
@dataclass
class AlbumGenre:
...
# src/main/python/com/tuempresa/ddex/domain/entities/albums/AlbumRights.py
@dataclass
class AlbumRights:
...
# src/main/python/com/tuempresa/ddex/domain/entities/albums/AlbumTrack.py
@dataclass
class AlbumTrack:
...
# src/main/python/com/tuempresa/ddex/domain/entities/albums/AlbumTrackRights.py
@dataclass
...
# src/main/python/com/tuempresa/ddex/domain/entities/genres/Genre.py
@dataclass
class Genre:
...
# src/main/python/com/tuempresa/ddex/domain/entities/labels/Label.py
@dataclass
class Label:
...
# src/main/python/com/tuempresa/ddex/domain/entities/contributors/Contributor.py
@dataclass
class Contributor:
...
# src/main/python/com/tuempresa/ddex/domain/entities/contributors/TrackContributor.py
@dataclass
...
# src/main/python/com/tuempresa/ddex/domain/entities/use_types/UseType.py
@dataclass
class UseType:
